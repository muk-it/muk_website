...
``sudo -H pip3 install --extra-index-url https://nexus.mukit.at/repository/odoo/simple odoo14-addon-muk-utils``
...
Go to your website and switch to the edit mode. Now the new snippets will appear
in your sidebar. Start with a section block to build your grid structure.
...
Some images and icons are based on or inspired by the icon set of Font Awesome:
